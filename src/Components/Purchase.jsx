  ...
  return (
    <>
           <div className='box'>
                          ...
                          <OverviewCard bg_primary='box_success' img={icon2} text='Purchase  Amount' cout='₹1,45,986' />
                          <OverviewCard bg_primary='box_warning mt-10' img={icon3} text='Return' cout='34' />
